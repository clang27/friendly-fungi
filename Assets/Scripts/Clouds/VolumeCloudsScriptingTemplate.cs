...
namespace Artngame.SKYMASTER {
    public class VolumeCloudsScriptingTemplate : MonoBehaviour {
        ...
        public bool changeCloudCoverage;
        ...
        private void Update() {
            ...
            if (affectTimeOfDay && frameCount > updateSunEvery) {
                ...
                var angles = cloudScript.Sun.transform.eulerAngles;
                cloudScript.Sun.transform.eulerAngles = new Vector3(
                    -12 + 200 / 2 - 100 * Mathf.Sin(Time.fixedTime * effectsRate),
                    -20 + 1 * 40 * Mathf.Cos(Time.fixedTime * effectsRate * 4), 89);
