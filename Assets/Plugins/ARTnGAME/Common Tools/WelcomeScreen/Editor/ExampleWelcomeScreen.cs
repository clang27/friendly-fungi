...
Sky Master ULTIMATE UPR Beta 24c and HDRP Beta 15 are available to 
all Sky Master ULTIMATE asset (Standard Pipeline system) users for 
download in Google Drive on PM request. The Beta versions are being 
developed on Unity 2021.3 LTS.
...
assets. Also must have downloaded Sky Master ULTIMATE store version, 
it is not needed to install it.");
