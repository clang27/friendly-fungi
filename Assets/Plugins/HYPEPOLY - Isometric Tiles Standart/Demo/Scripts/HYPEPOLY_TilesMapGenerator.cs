...
public class HYPEPOLY_TilesMapGenerator : MonoBehaviour {
    ...
    public GeneratorParameter holesCount;
    public GeneratorParameter holesSizes;
    public GeneratorParameter heightsCount;
    public GeneratorParameter heightsSizes;
    public GeneratorParameter maxHeight;
    ...
    private void AdditionalFilling(GeneratorParameter _additionalFilling, int sizeOfMap) {
        ...
        if (_additionalFilling != GeneratorParameter.None) {
            ...
            var circlesRange = (sizeOfMap/6f) + (((float)sizeOfMap / 30f) * (int)_additionalFilling);
